...
const ProfileDrawer: React.FC<ProfileDrawerProps> = ({
  ...
  // GETTING THE OTHER USERS DETAILS!
  const otherUser = useOtherUser(data);
  // JOINED DATE OF THAT USER WE HAVE OPENED ON RIGHT SIDE!
  const joinedDate = useMemo(() => {
    return format(new Date(otherUser.createdAt), 'PP');
  }, [otherUser.createdAt]);
  // TITLE MEANS THE NAME OF OTHER USER OPENED ON THE RIGHT SIDE OF OUR APP!
  const title = useMemo(() => {
...
const isActive = true;
  ...
  // TEXT THAT WILL BE SHOWN BELOW HEADER NAME OF OTHER USER!
